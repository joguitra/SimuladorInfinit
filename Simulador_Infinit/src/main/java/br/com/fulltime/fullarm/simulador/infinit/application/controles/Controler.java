...
public class Controler implements Initializable {
    ...
    void alterarzona1(MouseEvent event) {
        ...
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 1);
    ...
    void alterarzona2(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 2);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterarzona3(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 3);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterarzona4(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 4);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterarzona5(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 5);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
    ...
    void alterarzona6(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 6);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterarzona7(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 7);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterzona8(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(1, 8);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterarzona9(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ){
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 9);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }
    ...
    void alterarzona10(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 10);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterarzona11(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 11);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
    ...
    void alterarzona12(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 12);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
    ...
    void alterarzona13(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 13);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
    ...
    void alterarzona14(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 14);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
    ...
    void alterarzona15(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 15);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void alterarzona16(MouseEvent event) {
        if( event.getButton() == MouseButton.PRIMARY ) {
            ...
            if(memoria) {
                String codigo = formarcontactid.disparar(2, 16);
                conexao.printSaida(codigo);
                terminal.printTerminal(codigo);
            }
        }else if(event.getButton() == MouseButton.SECONDARY){
    ...
    void taperzona1(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao1.alterarTamper(efz1);
            String evento =(formarcontactid.enviarTamper(1,1,tamper));
    ...
    void taperzona2(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper = particao1.alterarTamper(efz2);
            String evento =(formarcontactid.enviarTamper(2,1,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona3(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao1.alterarTamper(efz3);
            String evento =(formarcontactid.enviarTamper(3,1,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona4(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao1.alterarTamper(efz4);
            String evento =(formarcontactid.enviarTamper(4,1,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona5(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao1.alterarTamper(efz5);
            String evento =(formarcontactid.enviarTamper(5,1,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona6(MouseEvent event) {
       if(event.getButton() == MouseButton.MIDDLE) {
           boolean tamper = particao1.alterarTamper(efz6);
           String evento =(formarcontactid.enviarTamper(6,1,tamper));
           conexao.printSaida(evento);
           terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona7(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao1.alterarTamper(efz7);
            String evento =(formarcontactid.enviarTamper(7,1,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona8(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao1.alterarTamper(efz8);
            String evento =(formarcontactid.enviarTamper(8,1,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);        }
    }
    ...
    void taperzona9(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz9);
            String evento =(formarcontactid.enviarTamper(9,2,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona10(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz10);
            String evento =(formarcontactid.enviarTamper(10,2,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona11(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz11);
            String evento =formarcontactid.enviarTamper(11,2,tamper) ;
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona12(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz12);
            String evento = (formarcontactid.enviarTamper(12, 2,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona13(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz13);
            String evento =(formarcontactid.enviarTamper(13,2,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);        }
    }
    ...
    void taperzona14(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz14);
            String evento =(formarcontactid.enviarTamper(14,2,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona15(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz15);
            String evento =(formarcontactid.enviarTamper(15,2,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void taperzona16(MouseEvent event) {
        if(event.getButton() == MouseButton.MIDDLE) {
            boolean tamper =particao2.alterarTamper(efz16);
            String evento =(formarcontactid.enviarTamper(16,2,tamper));
            conexao.printSaida(evento);
            terminal.printTerminal(evento);
        }
    }
    ...
    void alterarpgm1(MouseEvent event) {
      ...
      terminal.printTerminal(codigo);
      if(enviarcid){
          String codigopgm = formarcontactid.pgmCID("1");
          conexao.printSaida(codigopgm);
          terminal.printTerminal(codigopgm);
      }
    }
    ...
    void alterarpgm2(MouseEvent event) {
        ...
        terminal.printTerminal(codigo);
        if(enviarcid){
            String codigopgm = formarcontactid.pgmCID("2");
            conexao.printSaida(codigopgm);
            terminal.printTerminal(codigopgm);
        }
    }
    ...
    void alterarpgm3(MouseEvent event) {
        ...
        terminal.printTerminal(codigo);
        if(enviarcid){
            String codigopgm = formarcontactid.pgmCID("3");
            conexao.printSaida(codigopgm);
            terminal.printTerminal(codigopgm);
        }
    }
    ...
    void alterarpgm4(MouseEvent event) {
        ...
        terminal.printTerminal(codigo);
        if(enviarcid){
            String codigopgm = formarcontactid.pgmCID("4");
            conexao.printSaida(codigopgm);
            terminal.printTerminal(codigopgm);
        }
    }
    ...
    void alterarpgm5(MouseEvent event) {
        ...
        terminal.printTerminal(codigo);
        if(enviarcid){
            String codigopgm = formarcontactid.pgmCID("5");
            conexao.printSaida(codigopgm);
            terminal.printTerminal(codigopgm);
        }
    }
    ...
    void alterarpgm6(MouseEvent event) {
        ...
        terminal.printTerminal(codigo);
        if(enviarcid){
            String codigopgm = formarcontactid.pgmCID("6");
            conexao.printSaida(codigopgm);
            terminal.printTerminal(codigopgm);
        }
    }
    ...
    void alterarpgm7(MouseEvent event) {
        ...
        terminal.printTerminal(codigo);
        if(enviarcid){
            String codigopgm = formarcontactid.pgmCID("7");
            conexao.printSaida(codigopgm);
            terminal.printTerminal(codigopgm);
        }
    }
    ...
    void alterarpgm8(MouseEvent event) {
        ...
        terminal.printTerminal(codigo);
        if(enviarcid){
            String codigopgm = formarcontactid.pgmCID("8");
            conexao.printSaida(codigopgm);
            terminal.printTerminal(codigopgm);
        }
    }
    ...
    @FXML
    void btnarmartodos(MouseEvent event) {
        if(trocarzona == 1){
