...
import br.com.fulltime.fullarm.simulador.circle.pgm.PGM;
import br.com.fulltime.fullarm.simulador.circle.statusconectado.ConectadoCircle;
import br.com.fulltime.fullarm.simulador.conexao.Conexao;
import br.com.fulltime.fullarm.simulador.enviocontactid.FormarContactID;
import br.com.fulltime.fullarm.simulador.pesquisacid.ConfirmaPesquisa;
import br.com.fulltime.fullarm.simulador.pesquisacid.ListaCodigo;
import br.com.fulltime.fullarm.simulador.circle.particao.Particao;
import br.com.fulltime.fullarm.simulador.terminal.Terminal;
...
//        zonaPing.AlterarStatusEspecificoZona(StatusZona.Aberto);
//        esconderpane.mostrarPing();
//        Thread.sleep(1000);
//        esconderpane.escondePing();


    }

    @FXML
    void disparatodaszonas(MouseEvent event) throws InterruptedException {
        particao1.alterarTodasZonas(StatusZona.Disparado);
        particao2.alterarTodasZonas(StatusZona.Disparado);
//        esconderpane.mostrarPing();
//        zonaPing.AlterarStatusEspecificoZona(StatusZona.Disparado);
//        Thread.sleep(1000);
//        esconderpane.escondePing();
...
//        esconderpane.mostrarPing();
//        zonaPing.AlterarStatusEspecificoZona(StatusZona.Fechado);
//        Thread.sleep(500);
//        esconderpane.escondePing();
...
//        esconderpane.mostrarPing();
//        zonaPing.AlterarStatusEspecificoZona(StatusZona.Inibido);
//        Thread.sleep(500);
//        esconderpane.escondePing();
